...
pub fn parse_marinade_state(account_data: &[u8]) -> Result<MarinadeState> {
    Ok(MarinadeState::try_from_slice(account_data)?)
}

#[derive(BorshDeserialize, BorshSerialize, Clone, Default, Debug, PartialEq)]
